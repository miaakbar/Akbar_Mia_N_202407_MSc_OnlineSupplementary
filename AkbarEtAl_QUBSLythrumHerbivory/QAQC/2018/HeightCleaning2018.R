...
##removing x-x.13 columns since they are not relevant for E blocks(?)
heightdat <- select(heightdat, -X.1:-X.13)
...
write.csv(cleanIssuesDat, "2018_Field_Data/Data/Issues/issuesLythrum2018_withinrounds.csv", row.names = F)

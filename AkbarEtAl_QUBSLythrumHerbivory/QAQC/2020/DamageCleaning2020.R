...
summary(Dam)
unique(Dam$Block) #looks like "E7" is sometimes coded as "E7 "
Dam <- Dam %>% 
...
Dam$Date <- paste(Dam$Date, "-2020", sep = "")
...
round1 <- c("2020-06-18" , "2020-06-20")
round2 <- c("2020-07-01")
...
write.csv(Dam, "Data/Clean/2020_Dam_Clean.csv", row.names=F)
